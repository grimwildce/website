  ...
  return (
    <>
      ...
      <p>
        ...
        genres of fantasy, or just more to your table’s liking.
      </p>
      <h3>GRIMDARK</h3>
      <p>
      ...
      <ul>
        <li>PCs can’t cast potent spells.</li>
        <li>Make a 1d story roll when dropped.</li>
        <li>Marks only clear on rest, not when rolled.</li>
        <li>Vex responses are random.</li>
        <li>PC bonds are rolled randomly.</li>
        <li>Each PC has a 4d Supplies resource pool.</li>
      </ul>
      <h3>LOW FANTASY</h3>
      <p>
      ...
      <ul>
        <li>PCs can’t cast potent spells.</li>
        <li>Make a 1d story roll when dropped.</li>
        <li>Emphasis placed on vigilance, especially hint.</li>
        <li>Social fallout from vex responses increased.</li>
        <li>Carry 4 + Brawn items. Small, 1/2 slot. Big, 2+ slots.</li>
      </ul>
      <h3>SWORDS &amp; SORCERY</h3>
      <p>
        Adventurous, action-packed, and often pulpy. Glory, treasure hunting, and survival in
        dangerous worlds.
      </p>
      <ul>
        <li>No spellcasting PCs allowed.</li>
        <li>Make a 1d story roll when dropped.</li>
        <li>Clear marks and harm after any intense scene.</li>
        <li>Vex happens more often, but social fallout from vex responses is lessened.</li>
        <li>Each PC has a 4d Renown campaign timer.</li>
      </ul>
      <h3>HEROIC FANTASY</h3>
      <p>Inspirational and adventurous, with a focus on self-discovery and the hero’s journey.</p>
      <ul>
        <li>Default Grimwild rules.</li>
      </ul>
      <h3>NOBLEBRIGHT</h3>
      <p>
      ...
      <ul>
        <li>PCs begin at 2nd level with 1 minor arcana.</li>
        <li>Make a 3d story roll when dropped.</li>
        <li>PCs only die when the player agrees.</li>
        <li>Default damage is a mark, not harm.</li>
        <li>Rattled clears after any intense scene.</li>
        <li>Social fallout from vex responses heightened.</li>
      </ul>
      <h3>HIGH FANTASY</h3>
      <p>
      ...
      <ul>
        <li>PCs begin at 3rd level with 2 minor arcana or 1 major arcana.</li>
        <li>Mooks and toughs require no roll to take out.</li>
      </ul>
      <h3>COZY FANTASY</h3>
      <p>
        Wholesome, heartwarming, and low-stakes. Focused on friendship, personal growth, and simple
        joys in a magical world.
      </p>
      <ul>
        <li>Default is tame stakes. Normal must be declared.</li>
        <li>Default damage is a mark, not harm.</li>
        <li>XP only earned if one of your bonds changed or arcs finished that session.</li>
      </ul>
      <h2>GM TOOLS</h2>
      <p>
      ...
      <p>
        Choose all 7 elements first. Add sensory details— sights, sounds, and smells. Define what
        each wants to happen, or its pull on the story for nonsentient elements. Then set what it
        doesn’t want. Note one way to embody it at the table as the GM, like a behavior or sound
        effect. Keep everything short—just a few words (as below) per detail. Skip any steps you
        draw a blank on and make final notes if you have anything left to add.
      </p>
      <blockquote>
        <p>HARVEST FESTIVAL</p>
        <ul>
          <li>Wants everyone to leave with full bellies.</li>
          <li>Doesn’t want arguments about winter or toil.</li>
          <li>vibrant banners, overflowing carts, bonfires at dusk</li>
          <li>laughter and music, creak of carts, rustle of leaves</li>
          <li>roasted corn, spiced cider, damp post-harvest soil</li>
          <li>bite an apple, play a flute, raise a mug</li>
        </ul>
      </blockquote>
      <p>
      ...
      <p>
        ...
        players are given tokens to represent the “camera time” they have to act within a scene. At
        the start of an intense moment, give each player 2 tokens.
      </p>
      <p>
        Each major beat requires a player to spend a token before it begins, often an action roll.
        Play goes around until all are out of tokens, then players regain their tokens and it begins
        again. Everyone is ensured the same amount of screen time.
      </p>
      <p>
      ...
      <blockquote>
        <p>[!monster]</p>
        <p>
          Ranged devastators who unleash overwhelming power from afar, raining chaos on the
          battlefield. However, they crumble when the fight gets too close.
        </p>
        <table>
          <thead>
            <tr>
        ...
        <p>
          ...
          <em>to save their biggest hit for the greatest impact.</em>
          <em>
            <strong>Doesn’t want</strong>
          </em>{" "}
          <em>to lose targeting as enemies scatter.</em>
        </p>
        <h4>LAST DITCH DEFENSES (🎲)</h4>
        <ol>
          <li>
            <em>
              <strong>Unleashes</strong>
            </em>{" "}
            a sudden shockwave to clear space.
          </li>
          <li>
            Scrambles to{" "}
            <em>
              <strong>higher ground</strong>
            </em>
            .
          </li>
          <li>
            <em>
              <strong>Detonates</strong>
            </em>{" "}
            an explosive burst in all directions.
          </li>
          <li>
            Drags their enemy into{" "}
            <em>
              <strong>mutual destruction</strong>
            </em>
            .
          </li>
          <li>
            <em>
              <strong>Goes all in</strong>
            </em>{" "}
            with their full power in a final strike.
          </li>
          <li>
            <em>
              <strong>Fires wildly</strong>
            </em>{" "}
      ...
      <blockquote>
        <p>[!monster]</p>
        <p>
          Towering aggressors built for destruction, their sheer force overwhelms defenses. Each
          strike shakes the ground, leaving few standing in their path.
        </p>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td>
                ➕ <em>Unstoppable force</em>
              </td>
              <td>
                ⚔ <strong>CRUSHING BLOW</strong>
              </td>
            </tr>
            <tr>
              <td>
                ➕ <em>Towering resilience</em>
              </td>
              <td>
                🛡 <strong>GROUND SLAM</strong>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                ✨ <strong>INTIMIDATING ROAR</strong>
              </td>
            </tr>
          </tbody>
        </table>
        <p>
          ...
          to break lines and sow fear.
          <em>
            <strong>Doesn’t want</strong>
          </em>{" "}
          to be brought to a standstill.
        </p>
        <h4>WHEN CHALLENGED OR TAUNTED (🎲)</h4>
        <ol>
          <li>Bellows a deafening roar and charges.</li>
          <li>Hurls a massive object with crushing force.</li>
          <li>Stomps, sending foes stumbling.</li>
          <li>Slams fists together, daring enemies to approach.</li>
          <li>Mocks with a booming, guttural laugh.</li>
          <li>Rips up the ground, scattering debris.</li>
        </ol>
      </blockquote>
      <h4>LURKER</h4>
      <blockquote>
        ...
        <ol>
          <li>Strikes quickly to silence the nearest threat.</li>
          <li>Flees into the shadows, looking for new cover.</li>
          <li>Throws debris or objects to create a distraction.</li>
          <li>Slinks behind an ally or stronger creature.</li>
          <li>Unleashes a flurry of wild attacks.</li>
          <li>Abandons the fight entirely, escaping to safety.</li>
        </ol>
      </blockquote>
      <h4>MARKSMAN</h4>
      <blockquote>
        ...
        <ol>
          <li>Focuses on the closest threat for a critical shot.</li>
          <li>Dives into cover to avoid incoming attacks.</li>
          <li>Signals allies to draw enemy attention.</li>
          <li>Shifts to higher ground for a better vantage point.</li>
          <li>Takes a rapid, less accurate shot to disrupt foes.</li>
          <li>Retreats to reposition for the next attack.</li>
        </ol>
      </blockquote>
      <h4>MARAUDER</h4>
      <blockquote>
        ...
        <ol>
          <li>Charges forward recklessly, ignoring safety.</li>
          <li>Lashes out at the closest enemy in frustration.</li>
          <li>Circles their foes, looking for a weak spot.</li>
          <li>Rallies allies with a furious battle cry.</li>
          <li>Retreats momentarily to regain momentum.</li>
          <li>Smashes the environment to create new chaos.</li>
        </ol>
      </blockquote>
      <h4>OVERSEER</h4>
      <blockquote>
        ...
        <ol>
          <li>Calls for reinforcements with an urgent shout.</li>
          <li>Focuses on eliminating the biggest threat.</li>
          <li>Blames an ally, sowing discord to regain control.</li>
          <li>Directs allies to hold the line while they regroup.</li>
          <li>Retreats to a safer vantage point to reassess.</li>
          <li>Sacrifices an ally to buy time or ensure survival.</li>
        </ol>
      </blockquote>
      <h4>PREDATOR</h4>
      <blockquote>
        ...
        <ol>
          <li>Leaps to cut off the target’s escape.</li>
          <li>Refuses to give up no matter what.</li>
          <li>Roars, forcing a mistake.</li>
          <li>Circles, creating a trap to regain control.</li>
          <li>Strikes wildly in frustration, hitting all around.</li>
          <li>Vanishes, retreating to wait for another chance.</li>
        </ol>
      </blockquote>
      <h4>PROTECTOR</h4>
      <blockquote>
        ...
        <ol>
          <li>Steps in to block an incoming attack.</li>
          <li>Draws enemy attention with a loud challenge.</li>
          <li>Shoves the ally out of harm’s way.</li>
          <li>Counters with a heavy blow to create space.</li>
          <li>Raises a protective barrier to buy time.</li>
          <li>Sacrifices their position to shield the ally.</li>
        </ol>
      </blockquote>
      <h4>SKIRMISHER</h4>
      <blockquote>
        ...
        <ol>
          <li>Retreats quickly to regroup and reassess.</li>
          <li>Strikes recklessly, hoping to create an opening.</li>
          <li>Dodges wildly to avoid being hit.</li>
          <li>Circles, searching for a weak point to exploit.</li>
          <li>Taunts, trying to bait enemies into a mistake.</li>
          <li>Disengages, vanishing into the fray.</li>
        </ol>
      </blockquote>
      <h4>SWARMER</h4>
      <blockquote>
        ...
        <ol>
          <li>Presses harder, with reckless desperation.</li>
          <li>Retreats momentarily to regroup.</li>
          <li>Calls for reinforcement with frantic signals.</li>
          <li>Regroups, pulling forces into defensive cluster.</li>
          <li>Scatters, trying to avoid further losses.</li>
          <li>Breaks, abandoning the fight entirely.</li>
        </ol>
      </blockquote>
      <h4>TACTICIAN</h4>
      <blockquote>
        ...
        <ol>
          <li>Redirects allies to regroup and recover.</li>
          <li>Focuses on a single target to salvage the situation.</li>
          <li>Orders a retreat to reevaluate the fight.</li>
          <li>Shifts their attention to a new opportunity.</li>
          <li>Sacrifices weaker assets to regain momentum.</li>
          <li>Lashes out in frustration, acting recklessly.</li>
        </ol>
      </blockquote>
      <h4>TRICKSTER</h4>
      <blockquote>
        ...
        <ol>
          <li>Feigns weakness to lure enemies closer.</li>
          <li>Dodges frantically, hoping to regain control.</li>
          <li>Mocks enemies to draw attention away.</li>
          <li>Escapes, leaving a decoy in their place.</li>
          <li>Reverses their position, surprising the opponent.</li>
          <li>Lashes out in desperation to cover the failure.</li>
        </ol>
      </blockquote>
      ...
      <h3>GROUP-BUILDING QUESTIONS</h3>
      <p>
        During session zero after you’ve introduced your characters, or at interesting moments in a
        campaign, ask one of the following questions to the person on your right and left. Keep the
        questions leading and juicy, to give something interesting for you both to latch onto. You
        can also use these questions to delve into details about their character that you’re
        interested in hearing more about.
      </p>
      <h4>QUESTIONS ABOUT SHARED HISTORY</h4>
      <ul>
        <li>What secret did I tell you that you’ve never dared to share with anyone else?</li>
        <li>When we first met, what mistake did I make that still embarrasses me?</li>
        <li>What did we steal together, and how did it bring us closer?</li>
        <li>When did I save you from something, and what did it cost me?</li>
        <li>What moment made you decide you could trust me, even if you didn’t want to?</li>
      </ul>
      <h4>QUESTIONS ABOUT FEELINGS AND IMPRESSIONS</h4>
      <ul>
        <li>What’s something about me that annoys you, but you’d miss if I were gone?</li>
        <li>What’s a time I surprised you by being braver or softer than you expected?</li>
        <li>
          What’s a rumor about me you half believe, but you’re too afraid to ask if it’s true?
        </li>
        <li>When have I pushed you away, and how did it hurt?</li>
        <li>What do you envy about me, even if you’d never admit it out loud?</li>
      </ul>
      <h4>QUESTIONS ABOUT TENSIONS OR CHALLENGES</h4>
      <ul>
        <li>What’s a lie I told you that you’re still pretending to believe?</li>
        <li>What’s a promise I broke that you haven’t forgiven me for?</li>
        <li>When have I let you down, and how did you learn to work around me?</li>
        <li>What’s something dangerous you think I’m hiding from the group?</li>
        <li>What about me makes you feel like you’re walking on thin ice?</li>
      </ul>
      <h4>QUESTIONS ABOUT SHARED FUTURES</h4>
      <ul>
        <li>
          What’s a dream I have that you think is foolish, but you still want to help me achieve?
        </li>
        <li>What do you hope I’ll never find out about your plans?</li>
        <li>What do you think our journey will turn me into, and does that scare you?</li>
        <li>When this is all over, where do you imagine us going together?</li>
        <li>What’s something you think we’ll regret, but we’ll do it anyway?</li>
      </ul>
      <p>
        Note: Swapping “you” and “I” in most of these questions is possible—flip it around if it’s
        more interesting!
      </p>
      ...
      <p>INSERT RECREATION OF THIEVES CANT HERE FROM MATTHER KESSLER</p>
      <p>HOW TO USE</p>
      <ul>
        <li>Stack symbols vertically</li>
        <li>Read from bottom to top</li>
      </ul>
      <p>
      ...
      <h3>ARTIFICER</h3>
      <p>ALSO: Inventor, Mechanist, Tinkerer</p>
      <p>
        You shape the world with your creations, blending ingenuity, technology, and just a touch of
        magic to forge wonders from the mundane.
      </p>
      <blockquote>
        <p>INGENUITY (CORE TALENT)</p>
        <p>
          You harness the power of creativity. Begin play with 1 minor arcana and 1 major arcana,
          chosen from those on pg. 150 onwards or work with the GM to create your own arcana. You do
          not have talents—instead choose a gadget from your path list or reflavor a non-path talent
          as a gadget. Others can use your gadgets but take +1t and must always roll to use them.
        </p>
        <p>
          When given time, you can pull off potent feats of mechanical ingenuity like crafting a
          temporary device without proper materials or combining arcana and gadgets for wild
          effects. You can push yourself to do it on the spot.
        </p>
        <p>Engineering: Take +1d at creating, repairing, or destroying mechanisms and arcana.</p>
        <hr />
        <p>GROWTH: Every 2 levels, gain a new minor and major arcana.</p>
      </blockquote>
      <p>MAKING UP GADGETS [ADVICE]</p>
      <p>
      ...
      <p>MAGITECHNOBABBLE</p>
      <p>Roll 1 on each table, smash them together, and ramble on.</p>
      <table>
        <thead>
          <tr>
            <th>d66</th>
      ...
      <p>DOUBLE-BARRELED BLUNDERBUSS</p>
      <p>
      ...
      <blockquote>
        ...
        <hr />
        <p>GROWTH: Every 2 levels, learn a new bastion and gain 2 power points per session.</p>
      </blockquote>
      <p>BASTIONS</p>
      <p>
      ...
      <p>BIODYNAMICS • Altering and enhancing your own body.</p>
      <ul>
        <li>Key Stat: Brawn + Agility.</li>
        <li>Power: Heal your broken arm. Hold your breath for hours. Run faster than a horse.</li>
      </ul>
      <p>CLAIRSENTIENCE • Gaining knowledge and visions from the collective unconscious.</p>
      <ul>
        <li>Key Stat: Wits + Presence.</li>
        <li>Power: Sense a hidden truth. See into someone’s dreams. Find the way home.</li>
      </ul>
      <p>METACREATION • Creating objects from ectoplasm, pure mental energy.</p>
      <ul>
        <li>Key Stat: Brawn + Presence.</li>
        <li>
          Power: Forge a glowing sword. Build a bridge of thought. Shape armor from pure will.
        </li>
      </ul>
      <p>PSYCHOKINESIS • Manipulating energy and force.</p>
      <ul>
        <li>Key Stat: Brawn + Wits.</li>
        <li>Power: Shatter a boulder. Push an enemy back. Lift a heavy object with your mind.</li>
      </ul>
      <p>TELEPATHY • Mind-to-mind communication, manipulation, and control.</p>
      <ul>
        <li>Key Stat: Wits + Presence.</li>
        <li>
      ...
      <p>TRANSPOSITION • Movement and manipulation of space.</p>
      <ul>
        <li>Key Stat: Agility + Wits.</li>
        <li>Power: Teleport across a room. Switch places with an ally. Freeze someone in place.</li>
      </ul>
      <h4>PSION TALENTS</h4>
      <p>DISTURBED MIND</p>
      <p>
      ...
      <p>RING OF VIPERS</p>
      <p>The poisonous viper on the ring will uncoil and become a real viper.</p>
      <ul>
        <li>Touchstones: viper—venom—whispers</li>
        <li>Limitations: 4d power pool, refreshed by being bitten by the viper.</li>
      </ul>
      <p>JAR OF FLUTTERING MISCHIEF</p>
      <p>Releases butterfly swarms to distract and tickle someone nearby.</p>
      <ul>
        <li>Touchstones: butterflies—distraction—playfulness</li>
        <li>Limitations: 4d power pool, replenished by hearing a child’s hearty laughter.</li>
      </ul>
      <p>MINER’S ASSISTANT</p>
      <p>Burns brighter the deeper you go.</p>
      <ul>
        <li>Touchstones: light—depth—guidance</li>
        <li>Limitations: If a powerful creature lurks nearby, leads you to its new owner.</li>
      </ul>
      <p>HORN OF REVELRY</p>
      <p>Draws people to you who want to share stories. If you listen, they cheer up.</p>
      <ul>
        <li>Touchstones: charisma—revelry—festivity</li>
        <li>Limitations: Spend spark to use.</li>
      </ul>
      <p>RING OF PIERCING GAZE</p>
      <p>Peer through fog, smoke, or walls.</p>
      <ul>
        <li>Touchstones: perception—clarity—connection</li>
        <li>Limitations: If you see something sentient, it can also see you.</li>
      </ul>
      <p>SPIDERHEART WAND</p>
      <p>Calls normal spiders to weave normal webs wherever you point.</p>
      <ul>
        <li>Touchstones: spiders—web—control</li>
        <li>Limitations: 4d power pool, replenished by eating silk-wrapped bugs.</li>
      </ul>
      <p>GILDED SPECTACLES</p>
      <p>Reveals the best qualities and talents in everyone.</p>
      <ul>
        <li>Touchstones: insight—exaggeration—appreciation</li>
        <li>Limitations: Spend spark to use. Exaggerates those qualities.</li>
      </ul>
      <p>MAP OF PIRATE’S FOLLY</p>
      <p>Reveals the location of a treasure, which may or may not be real.</p>
      <ul>
        <li>Touchstones: maps—treasure—deception</li>
        <li>Limitations: Must loudly declare in public that you’re on a treasure hunt.</li>
      </ul>
      <p>FANGBOUND LEDGER</p>
      <p>Bites anyone but its owner.</p>
      <ul>
        <li>Touchstones: secrets—protection—temptation</li>
        <li>Limitations: If not written into, reveals its secrets to passers-by.</li>
      </ul>
      <p>BAG O’ TEETH</p>
      <p>Place a tooth in the bag. One time later, create an illusion of that creature.</p>
      <ul>
        <li>Touchstones: illusions—teeth—memory</li>
        <li>Limitations: Only 1 tooth ever per creature type.</li>
      </ul>
      <p>MUSIC BOX OF ECHOING MEMORIES</p>
      <p>Plays soft melodies that evoke fleeting, bittersweet memories.</p>
      <ul>
        <li>Touchstones: music—memory—nostalgia</li>
        <li>Limitations: 4d power pool, refreshed by genuine bittersweet tears.</li>
      </ul>
      <p>STAFF OF DISILLUSIONMENT</p>
      <p>Glows brightly red when an illusion is present nearby.</p>
      <ul>
        <li>Touchstones: perception—focus—truth</li>
        <li>Limitations: None.</li>
      </ul>
      <p>BATFRIEND PENDANT</p>
      <p>Warns of approaching intruders while outdoors at night.</p>
      <ul>
        <li>Touchstones: bats—vigilance—companionship</li>
        <li>Limitations: Only works outdoors at night.</li>
      </ul>
      <p>MIRROR OF PERFECT REFLECTIONS</p>
      <p>Shows a fleeting glimpse of the viewer’s best self.</p>
      <ul>
        <li>Touchstones: reflection—insight—hope</li>
        <li>Limitations: Take rattled when used, knowing that’s not you now.</li>
      </ul>
      <p>FEAR’S END</p>
      <p>When flown over a ship, appears as the viewer’s home nation’s flag.</p>
      <ul>
        <li>Touchstones: flag—trickery—hope</li>
        <li>Limitations: Displays an enemy nation’s flag to those with evil hearts.</li>
      </ul>
      <p>PICK ME UP TEAPOT</p>
      <p>Brews warm tea that removes all fatigue you might feel.</p>
      <ul>
        <li>Touchstones: rejuvenation—comfort—excess</li>
        <li>Limitations: Defense roll against vexed when drank—it can overdo it.</li>
      </ul>
      <p>STEADYHAND DAGGER</p>
      <p>Ignore thorns from rattled when using this dagger.</p>
      <ul>
        <li>Touchstones: courage—precision—malice</li>
        <li>Limitations: Will leap to your hand if you take vex.</li>
      </ul>
      <p>TWIGBOW</p>
      <p>Always supplies its wielder with arrows when among nature.</p>
      <ul>
        <li>Touchstones: nature—arrows—resourcefulness</li>
        <li>Limitations: Only works near trees.</li>
      </ul>
      <p>WIDOW’S REVENGE</p>
      <p>When you are dropped, the spider climbs off and attacks your killer.</p>
      <ul>
        <li>Touchstones: spider—venom—command</li>
        <li>Limitations: If killed, the spider is gone forever. It also despises murder.</li>
      </ul>
      <p>CHITTERFANG</p>
      <p>Vibrates like insect wings, striking with an unsettling hum.</p>
      <ul>
        <li>Touchstones: insect—precision—resonance</li>
        <li>Limitations: Loses power when the living bug on the hilt occasionally leaves.</li>
      </ul>
      <p>EVERFLAME</p>
      <p>Burns endlessly, no matter what you do to extinguish it.</p>
      <ul>
        <li>Touchstones: fire—light—perseverance.</li>
        <li>Limitations: You’re always stuck carrying a flaming object.</li>
      </ul>
      <p>SEEKER’S COMPASS</p>
      <p>Ask it “Where can I find ~?” and it will tell you. You always believe it.</p>
      <ul>
        <li>Touchstones: guidance—trust—hope</li>
        <li>Limitations: 4d power pool, rolled as a story roll. Replenished at 0d.</li>
      </ul>
      <h3>MAJOR ARCANA</h3>
      <p>
      ...
      <p>CIRCLET OF PRIMAL RESTORATION</p>
      <p>Regrows a lost limb over the course of one horribly painful hour.</p>
      <ul>
        <li>Touchstones: healing—regrowth—sacrifice</li>
        <li>Limitations: Take rattled when used.</li>
      </ul>
      <p>MAGEBANE BRACERS</p>
      <p>Always roll Brawn on defense rolls against magical attacks.</p>
      <ul>
        <li>Touchstones: resilience—anti-magic—shield</li>
        <li>Limitations: 8d Shatters, rolled on a messy. At 0d, messy becomes grim.</li>
      </ul>
      <p>RING OF DRACONIC MIRAGE</p>
      <p>Summons an illusory dragon that soars overhead.</p>
      <ul>
        <li>Touchstones: dragon—illusion—awe</li>
        <li>Limitations: Usable once per session. The dragon acts unpredictably.</li>
      </ul>
      <p>BLABBERMOUTH KEY</p>
      <p>Answers a question about a lock’s owner, but subsequent ones are half-truths.</p>
      <ul>
        <li>Touchstones: keys—locks—truths</li>
        <li>Limitations: 4d resource pool, replenished by telling it a well-kept secret.</li>
      </ul>
      <p>BOX OF SPIRITBINDING</p>
      <p>Holds a ghost you can summon. If empty, you can trap a spirit inside.</p>
      <ul>
        <li>Touchstones: ghosts—binding—horrifying</li>
        <li>Limitations: 4d Ghost Escapes, rolled with each use.</li>
      </ul>
      <p>BASILISK EYE CHARM</p>
      <p>Turns someone to stone with a gaze and grants immunity to petrification.</p>
      <ul>
        <li>Touchstones: petrification—gaze—protection</li>
        <li>Limitations: 4d power pool, replenished when it hits 0d.</li>
      </ul>
      <p>DISTURBING COUNSELOR</p>
      <p>Offers guidance on statecraft and reveals political secrets.</p>
      <ul>
        <li>Touchstones: wisdom—secrets—statecraft</li>
        <li>Limitations: 4d power pool, replenished by feeding its unnerving vices.</li>
      </ul>
      <p>POISONHEART PENDANT</p>
      <p>Twists relationships into spite and obsession, entangling emotions in toxicity.</p>
      <ul>
        <li>Touchstones: corruption—emotion—obsession</li>
        <li>Limitations: Only works on the one wearing it.</li>
      </ul>
      <p>FELL AXE</p>
      <p>Killing something with this axe ensures they can never be brought back.</p>
      <ul>
        <li>Touchstones: necromancy—violence—death</li>
        <li>Limitations: Demands you kill any you wield this against.</li>
      </ul>
      <p>RING OF BRIGHTNESS</p>
      <p>Channels a beam of blinding, burning light.</p>
      <ul>
        <li>Touchstones: light—intensity—beam</li>
        <li>Limitations: 8d power pool. Cannot be replenished.</li>
      </ul>
      <p>VERDANT SHIELD</p>
      <p>When struck, releases life energy causing plants to grow and ensnare foes.</p>
      <ul>
        <li>Touchstones: reaction—verdancy—entanglement</li>
        <li>Limitations: Push yourself to use it. It uses your own life energy.</li>
      </ul>
      <p>CODEX OF FLESH</p>
      <p>Turns into and acts like anyone who writes their name inside for 1 day.</p>
      <ul>
        <li>Touchstones: transformation—identity—knowledge</li>
        <li>Limitations: Can mimic each person once. Destroyed if seen by them.</li>
      </ul>
      <p>WISDOM OF ECHOING SOULS</p>
      <p>Contains faint impressions of previous owners. Gives three wises.</p>
      <ul>
        <li>Touchstones: wisdom—history—guidance</li>
        <li>Limitations: Spend spark to use it. Occasionally demands a favor.</li>
      </ul>
      <p>WAVEWALKER CHARM</p>
      <p>Lets the bearer stride across water as if it were solid ground.</p>
      <ul>
        <li>Touchstones: freedom—water—grace</li>
        <li>Limitations: 4d Sink, triggered by any action roll while using.</li>
      </ul>
      <p>CRYSTALSHARD SPRIG</p>
      <p>Fires crystal shards that encase targets.</p>
      <ul>
        <li>Touchstones: crystal—entrapment—precision</li>
        <li>Limitations: 4d power pool, replenished each session.</li>
      </ul>
      <p>DANCING SHOES</p>
      <p>Lets you dance with flawless grace, granting potency for 4d Runs Out.</p>
      <ul>
        <li>Touchstones: grace—beauty—dancing</li>
        <li>Limitations: Spend spark to use them.</li>
      </ul>
      <p>WAND OF STARLIGHT BLADES</p>
      <p>Sends out shimmering tendrils of light, cutting through darkness and foes.</p>
      <ul>
        <li>Touchstones: light—cutting—precision</li>
        <li>Limitations: 8d power pool, replenished on a cloudless, moonless night.</li>
      </ul>
      <p>SHADOWCLEAVE AXE</p>
      <p>Drains light from the air, creating an aura of shadows.</p>
      <ul>
        <li>Touchstones: shadows—cleaving—weight</li>
        <li>Limitations: 4d resource pool, replenished by killing two+ foes in one strike.</li>
      </ul>
      <p>IVYBINDING EARRINGS</p>
      <p>Ivy tendrils restrain the wearer when a command is spoken.</p>
      <ul>
        <li>Touchstones: nature—binding—trickery</li>
        <li>Limitations: The wearer must be able to hear the command.</li>
      </ul>
      <p>ORB OF FATEFUL WHISPERS</p>
      <p>Predicts outcomes of decisions when asked a non-secret yes/no question.</p>
      <ul>
        <li>Touchstones: foresight—risk—trickery</li>
        <li>Limitations: Defense roll against taking bloodied.</li>
      </ul>
      <p>FORESTWALK CHARM</p>
      <p>Allows you to move through dense foliage as effortlessly as walking a street.</p>
      <ul>
        <li>Touchstones: nature—movement—ease</li>
        <li>Limitations: None.</li>
      </ul>
      <p>EVERBLOODY SWORD</p>
      <p>Ignores thorns from difficulty in battle against foes not already bleeding.</p>
      <ul>
        <li>Touchstones: blood—sharpness—sacrifice</li>
        <li>Limitations: When not bloodied after wielding this in a fight, take bloodied.</li>
      </ul>
      <p>PORTALSCOPE</p>
      <p>Instantly teleports you safely to a place you can see through it.</p>
      <ul>
        <li>Touchstones: teleportation—vision—escape</li>
        <li>Limitations: Single use, then reverts to a mundane spyglass.</li>
      </ul>
      <h3>MYTHIC ARCANA</h3>
      <p>
      ...
      <p>MASK OF THE NAMELESS</p>
      <p>Erases your identity from the minds of all.</p>
      <ul>
        <li>Touchstones: anonymity—face—oblivion</li>
        <li>Limitations: Only usable three times. Randomly temporary or permanent.</li>
      </ul>
      <p>PENDANT OF FORGOTTEN SECRETS</p>
      <p>Whispers a forgotten secret from someone’s past when you meet them.</p>
      <ul>
        <li>Touchstones: memory—intrigue—encounter</li>
        <li>Limitations: Steals a memory from them, leaving them troubled.</li>
      </ul>
      <p>KEY TO FREEDOM</p>
      <p>Locates anyone, unlocking all doors in its path, and teleports them to safety.</p>
      <ul>
        <li>Touchstones: discovery—freedom—key</li>
        <li>Limitations: Located person becomes its new owner.</li>
      </ul>
      <p>RING OF GOOD FORTUNE</p>
      <p>Adds up to 3 points to any of your own story rolls.</p>
      <ul>
        <li>Touchstones: luck—balance—timing</li>
        <li>Limitations: Holds 3 points, replenished by taking 3 points from a story roll.</li>
      </ul>
      <p>DIMENSION SHARD</p>
      <p>Holds a small, town-sized refuge dimension where time flows differently.</p>
      <ul>
        <li>Touchstones: refuge—time—change</li>
        <li>Limitations: Time passes 10 times faster or slower inside, chosen randomly.</li>
      </ul>
      <p>SOULREAVER</p>
      <p>Stores the souls of slain worthy foes to unleash devastating final blows.</p>
      <ul>
        <li>Touchstones: souls—death—finality</li>
        <li>Limitations: Each kill banks 1d (3d), spendable to take +1d in a fight.</li>
      </ul>
      <p>SHIP IN A BOTTLE</p>
      <p>Transforms into a full-sized ship crewed by sailors for seven days.</p>
      <ul>
        <li>Touchstones: transformation—voyage—ship</li>
        <li>Limitations: Must reach a port within 7 days. Crew requires shore time.</li>
      </ul>
      <p>WAND OF LANDSLIDES</p>
      <p>Commands stone and soil to rise or fall at your will.</p>
      <ul>
        <li>Touchstones: earth—control—colossal</li>
        <li>Limitations: Roll Brawn to use it. Destabilizes the tectonics in the region.</li>
      </ul>
      <p>ORB OF WORLDS</p>
      <p>Reveals visions of distant realms and planes of existence.</p>
      <ul>
        <li>Touchstones: visions—realms—distant</li>
        <li>Limitations: Take rattled when used.</li>
      </ul>
      <p>VERMINSKULL RING</p>
      <p>Commands vermin to devour, reveal secrets, or retrieve valuables.</p>
      <ul>
        <li>Touchstones: vermin—command—swarm</li>
        <li>Limitations: 8d power pool, refreshed by feeding one of your fingers.</li>
      </ul>
      <p>HEARTHOLDER LOCKET</p>
      <p>Teleports the one you hold dearest directly to you.</p>
      <ul>
        <li>Touchstones: love—teleportation—openness</li>
        <li>Limitations: Only works if their feelings for you are mutual.</li>
      </ul>
      <p>HOMUNCULUS SEED</p>
      <p>Grows a living copy of someone, complete with their memories.</p>
      <ul>
        <li>Touchstones: replication—life—mystery</li>
        <li>Limitations: Must be planted and grow for a year and a day.</li>
      </ul>
      <p>JAR OF BOUND POWER</p>
      <p>Holds a terrible force disguised as a harmless fairy.</p>
      <ul>
        <li>Touchstones: malevolence—containment—destruction</li>
        <li>Limitations: Shatters violently if mishandled, unleashing its full power.</li>
      </ul>
      <p>GATEWAY PENDANT</p>
      <p>Opens a portal to a place the wielder cherishes deeply.</p>
      <ul>
        <li>Touchstones: portal—memory—longing</li>
        <li>Limitations: When you arrive, all memories of that place are lost.</li>
      </ul>
      <p>SPIDERCHANGE CIRCLET</p>
      <p>Transforms you into a spider, gaining limbs, fangs, webber, and instincts.</p>
      <ul>
        <li>Touchstones: transformation—instincts—spider</li>
        <li>Limitations: Only activates when it decides it’s needed.</li>
      </ul>
      <p>AEGISWING BLADE</p>
      <p>Fights alongside you as a trusted ally, as if a level 1 fighter with Bulwark.</p>
      <ul>
        <li>Touchstones: flight—protection—loyalty</li>
        <li>Limitations: If it is destroyed, you die.</li>
      </ul>
      <p>SHEPHERD’S CROOK OF THE LOST</p>
      <p>Draws wanderers and the forsaken to your side.</p>
      <ul>
        <li>Touchstones: guidance—connection—burden</li>
        <li>Limitations: None, except the weight of those who find you.</li>
      </ul>
      <h3>RANDOM POTIONS</h3>
      <p>
      ...
      <p>D8: attack—creation—defense—enhancement—hindrance—influence—transformation—traversal</p>
      <table>
        <thead>
          <tr>
            <th>d66</th>
      ...
      <ul>
        <li>A single talent and don’t advance.</li>
        <li>Simplified harm, with no marks.</li>
        <li>One positive trait and desire along with a negative one.</li>
        <li>No character arcs.</li>
        <li>No spark or story.</li>
        <li>Only backgrounds listed, no wises.</li>
        <li>Only bonds with the PC.</li>
      </ul>
      <p>
      ...
      <h3>VIGILANCE &amp; PERCEPTION CHECKS</h3>
      <p>
      ...
      <h3>STORY AND WHY IT MATTERS</h3>
      <p>
